<%@ Page Title="About Us" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="sqlserverapp.aspx.cs" Inherits="About" %>
...
Lets see what did you ate over the week from sql server database
					...
					<asp:SqlDataSource ID="SqlDataSource2" runat="server" 
						ConnectionString="<%$ ConnectionStrings:appharborsqlserver %>" 
						SelectCommand="SELECT [color], [amount], [description] FROM [eating]"></asp:SqlDataSource>
</div>
</asp:Content>
